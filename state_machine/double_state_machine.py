...
with model:
	...
	actions = spa.Actions(
		...
		### FIND FOOD 
		'dot(subgoal, START_FIND_FOOD) --> find_state=START, subgoal=FIND_FOOD, go_state=STOP',
		...
		### GO TO FOOD
		'dot(subgoal, START_GO_TO_FOOD) --> go_state=START, subgoal=GO_TO_FOOD, find_state=STOP',
